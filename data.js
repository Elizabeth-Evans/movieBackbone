var movie = [
  {
    ...
    coverImg:"img/force.jpg",
    desc:"Lucasfilm and visionary director J.J. Abrams join forces to take you back again to a galaxy far, far away as Star Wars returns with Star Wars: The Force Awakens.",
    star:"Harrison Ford, Mark Hamill",
    runTime:"2 hours, 15 minutes"
  },
  {
    title: "The Revenant",
    coverImg:"img/revenant.jpg",
    desc:"Leonardo DiCaprio and Tom Hardy star in Alejandro G. Iñárritu's visceral, epic tale of survival and betrayal inspired by true events that's set in America's uncharted wilderness.",
    star: "Leonardo Dicaprio, Tom Hardy",
  ...
  {
    title: "Deathgasm",
    coverImg:"img/deathgasm.jpg",
    desc: "Two high school metalheads play a forbidden piece of music that unlocks the gates of hell. Now the two headbangers and a metal maiden must join forces to save their town from a demonic onslaught.",
    star: "Milo Cawthorne, James Blake",
  ...
  {
    title: "Brooklyn",
    coverImg:"img/brooklyn.jpg",
    desc: "In this charming love story based on the best-selling novel, a young Irish immigrant (Saoirse Ronan) travels to New York City and is torn between two countries and two men.",
    star: "Saoirse Ronan, Domhnall Gleeson",
